...
import {createApp, ref, reactive, Ref, computed, onMounted} from 'vue';
...
import { ComponentVue, Component } from "./modules/fixClass/Group.js";
...
window.fixTree = reactive(new FIXTree()) as FIXTree;
...
createApp({
    setup() {
        ...
        const filteredComponents = computed(() => {
            let filtered = new Map<string, Component>();
